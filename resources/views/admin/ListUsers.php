                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?=format_cash($TN->num_rows("SELECT * FROM `users`"))?>
                                thành viên</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number"><?=format_cash($TN->get_row("SELECT SUM(`money`) FROM `users` ")['SUM(`money`)']);?>đ</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Admin:
                                <?=format_cash($TN->num_rows("SELECT * FROM `users` WHERE `level`='admin'"))?></span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <?=format_cash($TN->num_rows("SELECT * FROM `users` WHERE `banned`='1'"))?> tài
                                khoản</span>
                        </div>
                    </div>
                </div>
